...
const InternationalProjectsManagementPage = () => {
  ...
  const fetchInternationalData = async () => {
    try {
      ...
      if (res.status === 404) {
        setInternationalData({ galleryImages: [] })
        setFetching(false)
        return
      }
      ...
      setMessage({ type: 'error', text: 'Failed to load international projects data' })
    } finally {
      setFetching(false)
    }
  }
  ...
  const saveBasicInfo = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setInternationalData(result.data)
      } else {
  ...
  const saveHeroImage = async () => {
    ...
    try {
      ...
      formData.append('alt', 'International Projects Hero')

      const res = await fetch(`${API_URL}/international-projects/hero-image`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  const addGalleryImage = async () => {
    ...
    try {
      ...
      formData.append('title', imageTitle || 'International Project')
      formData.append('description', imageDescription || 'An iconic international project.')
      formData.append('alt', imageAlt || 'International Project')
      ...
      const res = await fetch(`${API_URL}/international-projects/gallery-image`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  const updateGalleryImage = async (imageId) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/international-projects/gallery-image/${imageId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`
        },
      ...
      <AdminLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading international projects data...</p>
          </div>
        </div>
      </AdminLayout>
    )
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="e.g., 'Icons of The World'"
                      value={imageTitle}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="e.g., 'International Client'"
                      value={imageClient}
          ...
          {internationalData?.galleryImages && internationalData.galleryImages.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {internationalData.galleryImages.map((image, index) => (
