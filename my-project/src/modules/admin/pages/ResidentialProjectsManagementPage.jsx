...
const ResidentialProjectsManagementPage = () => {
  ...
  const fetchProjects = async () => {
    try {
      ...
      setMessage({ type: 'error', text: 'Failed to load residential projects' })
    } finally {
      setLoading(false)
    }
  }
      ...
      <AdminLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading residential projects...</p>
          </div>
        </div>
      </AdminLayout>
    )
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-800">Residential Projects List</h2>
          </div>
          ...
          {projects.length === 0 ? (
            <div className="p-8 text-center text-gray-500">
              ...
              <p className="text-lg font-medium">No residential projects found</p>
              <p className="text-sm">Residential projects will appear here once they are added to the system.</p>
            </div>
          ) : (
