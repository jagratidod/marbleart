  ...
  for (let day = 1; day <= daysInMonth; day++) {
    ...
    dates.push(
      <button
        ...
        disabled={isPast}
        className={`h-8 md:h-10 rounded-lg text-xs md:text-sm font-medium transition-colors ${isSelected
        ...
        <div className="p-4 md:p-5 lg:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-4 md:mb-6">
            <div
              ...
              className={`border-2 rounded-lg p-4 md:p-5 cursor-pointer transition-all shadow-md ${bookingData.appointmentType === 'store-tour'
                  ? 'border-[#8B7355] bg-gray-50'
                  : 'border-gray-300 hover:border-gray-400 bg-white'
                }`}
            >
              <div className="flex items-start gap-3">
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 mt-0.5 ${bookingData.appointmentType === 'store-tour'
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 ${bookingData.appointmentType === 'store-tour' ? 'bg-[#8B7355]' : 'bg-gray-400'
                      }`}>
            ...
            <div
              ...
              className={`border-2 rounded-lg p-4 md:p-5 cursor-pointer transition-all shadow-md ${bookingData.appointmentType === 'temple-customization'
                  ? 'border-[#8B7355] bg-gray-50'
                  : 'border-gray-300 hover:border-gray-400 bg-white'
                }`}
            >
              <div className="flex items-start gap-3">
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 mt-0.5 ${bookingData.appointmentType === 'temple-customization'
                    ? 'border-[#8B7355] bg-[#8B7355]'
                    : 'border-gray-400'
                  }`}>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 ${bookingData.appointmentType === 'temple-customization' ? 'bg-[#8B7355]' : 'bg-gray-400'
                      }`}>
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-2 md:gap-3">
                  {timeSlots.map((time) => (
                    <button
                      ...
                      className={`px-3 py-2 md:px-4 md:py-2.5 rounded-lg text-xs md:text-sm font-medium transition-all shadow-sm ${bookingData.selectedTime === time
                          ? 'bg-[#8B7355] text-white shadow-md'
